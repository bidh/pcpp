...
public class TestCountPrimesThreads {
  public static void main(String[] args) {
    ...
    for (int c=1; c<=15; c++) {
     ...
     /* Mark7(String.format("countParallelNAL %6d", threadCount),
            i -> countParallelNAL(range, threadCount));*/
      Mark7(String.format("countParallelNThreadConfined %6d", threadCount), 
            i -> countParallelNThreadConfined(range, threadCount));
    }
  }
  ...
  private static long countParallelNAL(int range, int threadCount) {
  ...
  // General parallel solution, using multiple threads and AtomicLong
  ...
  // General parallel solution, using multiple threads and AtomicLong thread confined
  private static long countParallelNThreadConfined(int range, int threadCount) {
    final int perThread = range / threadCount;
    //final LongCounter lc = new LongCounter();	
	final AtomicLong lc=new AtomicLong(0);
    Thread[] threads = new Thread[threadCount];
